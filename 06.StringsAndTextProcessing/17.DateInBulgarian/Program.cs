...
and prints the date and timeafter 6 hours and 30 minutes (in the same format) along with the day of week in Bulgarian.
*/
...
class DateInBulgarian
{
    static void Main()
    {
        ...
        Console.WriteLine("6:30 часа по-късно: {0}, {1}",
            DateTimeFormatInfo.CurrentInfo.GetDayName(inputDate.DayOfWeek), inputDate);
    }
}
